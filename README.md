# [My Personal Website](https://zeroinverse.github.io/)
#### using bootstrap
This is the base repository for my personal resume website.
I made this using startbootstrap-resume template, which features a fixed sidebar with content sections to build a simple, yet elegant resume. You can also build your own website using the steps that I have given below, based on the original author's guidelines:
...
### (THESE LINKS LINK TO THE ORIGINAL AUTHOR's REPOSITORY)
